...
public:
    ...
    QList<QLine> draw(Window *window, Clipping *frame, int windowScale, int windowAngleX, int windowAngleY, int windowAngleZ, int windowPosX, int windowPosY, int windowPosZ, int focalDistance);
